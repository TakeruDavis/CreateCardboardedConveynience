...
@Mod(CreateCardboardedConveynience.MODID)
public class CreateCardboardedConveynience
{
    ...
    public CreateCardboardedConveynience(IEventBus modEventBus, ModContainer modContainer)
    {
        modEventBus.addListener(this::commonSetup);

        NeoForge.EVENT_BUS.register(this);
        NeoForge.EVENT_BUS.register(CardboardHelper.class);
    ...
    private void commonSetup(final FMLCommonSetupEvent event)
    {
        ...
        LOGGER.info("Hotswap fix is {}", Config.hotswapFix ? "enabled" : "disabled");
    }
