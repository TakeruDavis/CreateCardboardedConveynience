...
public class InvisiblePackageHelper {
    ...
    public static void register() {
        ...
        PartialModel invisiblePackage = PartialModel.of(
            ResourceLocation.fromNamespaceAndPath(CardboardedConveynience.MOD_ID, "item/invisible_package")
        );
        PartialModel invisibleRigging = PartialModel.of(
            ResourceLocation.fromNamespaceAndPath(CardboardedConveynience.MOD_ID, "item/invisible_rigging")
        );
