...
public class FrogportDeliveryScene {
    ...
    public static void frogportDelivery(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        storageTag.set(DataComponents.CUSTOM_NAME, Component.literal("Storage"));
        ItemStack workshopTag = new ItemStack(Items.NAME_TAG);
        workshopTag.set(DataComponents.CUSTOM_NAME, Component.literal("Workshop"));
        ...
        wildcardTag.set(DataComponents.CUSTOM_NAME, Component.literal("Stor*"));
