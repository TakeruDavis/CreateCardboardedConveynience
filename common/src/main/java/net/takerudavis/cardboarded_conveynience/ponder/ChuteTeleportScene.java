...
public class ChuteTeleportScene {
    ...
    public static void chuteTeleport(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world().setBlock(util.grid().at(5, 4, 5),
            BuiltInRegistries.BLOCK.get(ResourceLocation.fromNamespaceAndPath("create", "chute")).defaultBlockState(), false);
        scene.idle(20);
        ...
        scene.world().setBlock(util.grid().at(5, 7, 5),
            BuiltInRegistries.BLOCK.get(ResourceLocation.fromNamespaceAndPath("create", "smart_chute"))
